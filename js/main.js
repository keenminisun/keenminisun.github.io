document.addEventListener('DOMContentLoaded', () => {
  ...
  const handleSocialEmailCopy = async e => {
    const link = e.target.closest('.social-icon[data-copy-email]')
    if (!link) return
    ...
    try {
      ...
      showCopyMessage('Could not copy email')
    }
  }
 ...
 */
  ...
  const unRefreshFn = () => {
    ...
    document.body.addEventListener('click', handleSocialEmailCopy)
